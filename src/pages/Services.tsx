...
import { Video, MessageSquare, Zap, Sparkles, Code, Smartphone, TrendingUp, Camera, ArrowRight } from "lucide-react";
const Services = () => {
  const services = [{
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {services.map((service, index) => <Card key={index} className="group hover:scale-[1.02] transition-all duration-300 hover:shadow-2xl glass border-2 hover:border-primary/50">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-2">
                    {service.features.map((feature, i) => <div key={i} className="flex items-center space-x-2 text-sm text-muted-foreground">
