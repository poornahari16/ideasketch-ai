      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6 text-green-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {caseStudies.map((study, index) => <Card key={study.id} className="group glass border-2 hover:border-primary/50 hover:scale-[1.02] transition-all duration-300 overflow-hidden">
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-3 gap-4">
                    {study.results.map((result, i) => <div key={i} className="text-center">
