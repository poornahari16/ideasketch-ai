      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6 text-green-500">
            ...
            <div className="max-w-xl mx-auto">
              <div className="relative">
                ...
                <Input type="search" placeholder="Search articles..." className="pl-10 bg-card border-2" />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3 justify-center mb-12">
            {categories.map((category, index) => <Button key={index} variant={index === 0 ? "default" : "outline"} className={index === 0 ? "" : "hover:bg-primary hover:text-primary-foreground"}>
                {category}
              </Button>)}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.slice(1).map((post, index) => <Card key={post.id} className="group glass border-2 hover:border-primary/50 hover:scale-105 transition-all overflow-hidden">
          ...
          <Card className="glass border-2 border-primary/30 overflow-hidden mt-20">
            <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                <Input type="email" placeholder="Enter your email" className="bg-background border-2" />
