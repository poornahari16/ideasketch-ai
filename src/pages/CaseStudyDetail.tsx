  ...
  const caseStudyData: Record<string, any> = {
    "south-indian-filter-coffee": {
      ...
      challenge: {
        title: "The Challenge",
        points: [
          "Limited marketing budget for luxury product launch",
          "Needed professional video content quickly",
          "Required 24/7 customer engagement during launch",
          "Tight 3-day deadline before launch event",
        ],
      },
      solution: {
        title: "Our Solution",
        ...
        points: [
          "Created 3 high-quality AI-generated promotional videos showcasing the luxury positioning",
          "Implemented an intelligent chatbot trained on product details and brand voice",
          "Set up automated customer query handling for pre-launch inquiries",
          "Designed engaging video narratives highlighting premium ingredients and heritage",
        ],
      },
      results: {
        title: "The Results",
        metrics: [
          { label: "Engagement Increase", value: "65%", description: "Compared to industry average" },
          { label: "Project Timeline", value: "3 Days", description: "From brief to deployment" },
          { label: "Cost Savings", value: "70%", description: "Vs. traditional production" },
          { label: "Customer Queries", value: "500+", description: "Handled automatically" },
        ],
      },
      testimonial: {
    ...
    "desi-chai": {
      ...
      challenge: {
        ...
        points: [
          ...
          "Limited resources for professional content",
        ],
      },
      solution: {
        title: "Our Solution",
        ...
        points: [
          "AI-generated promotional videos optimized for social platforms",
          "Automated social media posting across multiple channels",
          "Intelligent response system for customer inquiries",
          "Content calendar automation with best-time posting",
        ],
      },
      results: {
        title: "The Results",
        metrics: [
          { label: "Response Speed", value: "90% Faster", description: "Customer query handling" },
          { label: "Content Output", value: "5x More", description: "Posts per week" },
          { label: "Engagement Rate", value: "+120%", description: "Across all platforms" },
          { label: "Time Saved", value: "20 hrs/week", description: "For marketing team" },
        ],
      },
      testimonial: {
    ...
    "gs-water-supplies": {
      ...
      challenge: {
        title: "The Challenge",
        points: [
          "Limited online presence in competitive market",
      ...
      solution: {
        ...
        points: [
          "Performance marketing campaigns targeting local audiences",
      ...
      results: {
        title: "The Results",
        metrics: [
          { label: "Local Reach", value: "+200%", description: "Service area coverage" },
          { label: "Lead Quality", value: "+85%", description: "Higher intent customers" },
          { label: "ROI", value: "3.5x", description: "Marketing spend return" },
          { label: "Search Ranking", value: "Top 3", description: "Local search results" },
        ],
      },
      testimonial: {
    ...
    "tea-time": {
      ...
      challenge: {
        title: "The Challenge",
        points: [
          "Hundreds of franchise inquiries per week",
          "Time-consuming manual lead qualification",
          "Inconsistent follow-up process",
          "High-quality leads lost in the noise",
        ],
      },
      solution: {
        title: "Our Solution",
        ...
        points: [
          "AI agent trained on franchise requirements and qualification criteria",
          "Automated initial inquiry handling and information gathering",
          "Intelligent lead scoring and prioritization system",
          "Seamless handoff to human team for qualified leads",
        ],
      },
      results: {
        title: "The Results",
        metrics: [
          { label: "Time Saved", value: "15 hrs/week", description: "For franchise team" },
          { label: "Lead Quality", value: "+160%", description: "Better qualification" },
          { label: "Conversion Rate", value: "+45%", description: "Inquiry to franchise" },
          { label: "Response Time", value: "Instant", description: "24/7 availability" },
        ],
      },
      testimonial: {
    ...
    "sofa-studio": {
      ...
      challenge: {
        title: "The Challenge",
        points: [
          "Expensive traditional product photography",
          "Slow turnaround for new product images",
          "Delayed customer service responses",
          "Limited ability to visualize products in different settings",
        ],
      },
      solution: {
        title: "Our Solution",
        ...
        points: [
          "AI-generated product visuals in multiple settings and angles",
          "Lifestyle imagery creation without photoshoots",
          "24/7 customer chat automation for inquiries",
      ...
      results: {
        title: "The Results",
        metrics: [
          { label: "Photography Costs", value: "-80%", description: "Compared to traditional" },
          { label: "Response Time", value: "Instant", description: "Customer inquiries" },
          { label: "Sales Increase", value: "+95%", description: "Better product presentation" },
          { label: "Turnaround", value: "24 Hours", description: "New product images" },
        ],
      },
      testimonial: {
    ...
    <div className="min-h-screen bg-background dark">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-5xl">
            ...
            <CardContent className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {data.results.metrics.map((metric: any, i: number) => (
                  <div key={i} className="bg-card/50 rounded-lg p-6 border border-border">
          ...
          {/* Technologies Used */}
          <div className="mb-12">
            <h3 className="text-2xl font-heading font-bold mb-4">Technologies Used</h3>
