            ...
            <Card className="glass border-2">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  })} placeholder="+1 (555) 000-0000" className="bg-background/50" />
                  </div>
                  ...
                  })} placeholder="Tell us about your project..." rows={5} className="bg-background/50 resize-none" />
                  </div>
...
9am-6pm IST</p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Andhra Pradesh</p>
              ...
              <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl p-8 space-y-4">
                <h3 className="text-2xl font-heading font-bold text-lime-500">Quick Start?</h3>
                <p className="text-muted-foreground">
